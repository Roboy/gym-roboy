...
def test_msj_env_new_goal_is_different_and_feasible():
    for _ in range(10):
...
def test_msj_env_reaching_goal_angle_delivers_maximum_reward():
    obs = env.reset()
...
def test_msj_env_render_does_nothing():
    env.render()
